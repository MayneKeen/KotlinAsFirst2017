 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = (grad+(min+sec/60.0)/60.0)* PI/180.0
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * (1.0 + percent*0.01)*(1.0 + percent*0.01)*(1.0 + percent*0.01)
/**
 * Простая
 *
